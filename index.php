...
<head>
	...
	<script>
		window.addEventListener("load", function() {
			window.wpcc.init({
				...
				"content": {
					"href": "https://www.inspirationjar.com/cookie_policy.html"
				}
			})
		});
	</script>
	...
	<script async src="https://www.googletagmanager.com/gtag/js?id=UA-178410803-3"></script>
	<script>
